-- ============================================================
-- FutureKawa — Schema BDD — Colombie
-- ============================================================
...
CREATE TABLE IF NOT EXISTS entrepots (
    ...
    pays            VARCHAR(50)  NOT NULL DEFAULT 'colombie',
    temp_ideale     DECIMAL(5,2) NOT NULL DEFAULT 26.0,
    hum_ideale      DECIMAL(5,2) NOT NULL DEFAULT 80.0,
